        ...
        <div className="flex flex-wrap items-start justify-between gap-8 pt-10 border-t border-[#2B2D2A]">
          ...
          <div className="flex flex-wrap gap-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs">
                <li><a href="https://github.com/riddhibantia/Finsheild" target="_blank" rel="noreferrer" className="text-[#A7AAA3] hover:text-[#F2EFE7] transition-colors">GitHub Repository</a></li>
...
export function LandingPage() {
  ...
  const [upiSender, setUpiSender] = useState<string>("demo@okhdfc");
